return {
...

  {
    ...
    opts = function()
      ...
      local kind_icons = require('user.constants').lsp_kind_icons
      local source_mapping = require('user.constants').source_mapping
      local sources        = require('user.constants').sources
